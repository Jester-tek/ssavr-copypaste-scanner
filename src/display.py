...
class SplitScreenDisplay:
    ...
    def __init__(self):
        ...
        self.tor_success = 0
        self.tor_fail = 0
        self.tor_new_found = 0
        self.proxy_new_found = 0
    ...
    def _render_unlocked(self):
        ...
        if self.tor_success or self.tor_fail or self.tor_new_found:
            new_text = f" [cyan]✨ {self.tor_new_found}[/cyan]" if self.tor_new_found else ""
        ...
        if self.proxy_success or self.proxy_fail or self.proxy_new_found:
            new_text = f" [cyan]✨ {self.proxy_new_found}[/cyan]" if self.proxy_new_found else ""
